...
public class ReverseWords {
    ...
    /**
     * @param sent   list of characters in which we reverse the part from start to
     *               finish
     * @param start  starting index from which we're reversing
     * @param finish end last index, included, to which we're reversing
     */
